...
if defined?(ActiveRecord)
  ...
  Article.create(title: 'MyCypressFixtures', body: 'This is the body')
  Article.create(title: 'MyCypressFixtures2', body: 'This is the body')
  Article.create(title: 'MyRailsFixtures', body: 'This is the body')
  Article.create(title: 'MyRailsFixtures2', body: 'This is the body')
end
